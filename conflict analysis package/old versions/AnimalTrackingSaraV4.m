...
function [] = AnimalTrackingSaraV4(event_groups, pre_times, post_times, baseline_times, control_fiber, signal_fibers, fiber_names)
do_crop = 0;
sound_offset = 0;
time_after_sound_onset_to_check = 0;
event_labels = {'water', 'light', 'sound', 'laser', 'shock', 'shock received', 'shock avoided', 'sound in shock received', 'sound in shock avoided', 'platform entries', 'platform exits', 'sound platform entries', 'first platform entries', 'first platform exits after shock', 'ITI platform entries'};
